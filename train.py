...
def main():
    ...
    # Data loading code # args.data: path to the dataset
    traindir = os.path.join(r'C:\Users\30394986\OneDrive - Federation University Australia (1)\Desktop\CURE-OR\Train and test dataset\Contrast\Gaussian Train')
    testdir = os.path.join(r'C:\Users\30394986\OneDrive - Federation University Australia (1)\Desktop\CURE-OR\Train and test dataset\Contrast\Gaussian Test')

#C:\Users\30394986\OneDrive - Federation University Australia (1)\Desktop\python\__pycache__\Real_Train\Snow combined\Snow-123
#C:\Users\30394986\OneDrive - Federation University Australia (1)\Desktop\python\__pycache__\Real_Test\Snow combined\SSIM0.7\Snow-123
    ...
    savedir = r'C:\Users\30394986\OneDrive - Federation University Australia (1)\Desktop\python\CNN_iter'
    ...
    #cross entropy is used for multiclass classification loss 
...
def adjust_learning_rate(optimizer, epoch):
    ...
    for param_group in optimizer.param_groups:
        param_group['lr'] = lr
#k=Number of most likely outcomes considered to find the correct label.
